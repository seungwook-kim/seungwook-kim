...
const SESSION = [
  ...
  { out: 'AI developer. I train, evaluate, and ship models.', y: 220, at: 2.35 },
  { cmd: 'ls ./domains', y: 264, at: 2.75 },
  { dirs: ['speech/', 'nlp/', 'vision/', 'audio/', 'deploy/'], y: 294, at: 3.55 },
];
...
function svg(t) {
  ...
  <desc id="desc">Terminal-style header: AI developer working across speech, NLP, vision, audio, and deployment.</desc>
  <style>
